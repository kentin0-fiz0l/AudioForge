          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-background border border-primary/30 rounded-2xl p-8 md:p-12 text-center shadow-glow-primary">
              ...
              <p className="text-foreground-muted text-lg mb-8 max-w-2xl mx-auto">
                Download AudioForge v2.0.2 with 39 plugins (VST3 & AU), universal preset management, and full MIDI Learn support. Includes critical stability fix. Free forever, no strings attached.
              </p>
              <a
