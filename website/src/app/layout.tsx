...
export const metadata: Metadata = {
  title: "AudioForge - 39 Professional VST3 Plugins | v2.0.2",
  description: "39 professional VST3 and AU plugins with universal preset management and MIDI Learn. v2.0.2 includes critical stability fix. Free, open source, and professional-grade.",
  ...
  openGraph: {
    ...
    title: 'AudioForge - 39 Professional VST3 & AU Plugins | v2.0.2',
    description: '39 professional audio plugins with universal preset management and MIDI Learn. v2.0.2 includes critical stability fix. Built with JUCE, free and open source.',
    siteName: 'AudioForge',
  },
  twitter: {
