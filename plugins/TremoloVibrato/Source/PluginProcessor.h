...
class TremoloVibratoProcessor : public juce::AudioProcessor {
public:
    TremoloVibratoProcessor();
    ~TremoloVibratoProcessor() override;
    void prepareToPlay(double, int) override;
    void releaseResources() override {}
    void processBlock(juce::AudioBuffer<float>&, juce::MidiBuffer&) override;
    juce::AudioProcessorEditor* createEditor() override;
    bool hasEditor() const override { return true; }
    const juce::String getName() const override { return "TremoloVibrato"; }
...
private:
    ...
    TremoloVibratoEngine engine_;
    void updateEngineParameters();
    AudioForge::MIDILearnManager midiLearnManager_;
    AudioForge::PresetManager presetManager_;

JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(TremoloVibratoProcessor)
};
