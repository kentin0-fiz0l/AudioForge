...
class MIDIHarmonizerProcessor : public juce::AudioProcessor {
public:
    MIDIHarmonizerProcessor();
    ~MIDIHarmonizerProcessor() override;
    ...
    const juce::String getName() const override { return "MIDI Harmonizer"; }
...
private:
    ...
    HarmonizerEngine engine_;

    void updateEngineParameters();

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(MIDIHarmonizerProcessor)
};
