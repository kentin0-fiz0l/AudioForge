...
public:
    MIDICCMapperProcessor();
    ~MIDICCMapperProcessor() override;
    ...
    const juce::String getName() const override { return "MIDI CC Mapper"; }
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(MIDICCMapperProcessor)
};
