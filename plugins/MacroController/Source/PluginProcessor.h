...
public:
    MacroControllerProcessor();
    ~MacroControllerProcessor() override;
    ...
    const juce::String getName() const override { return "Macro Controller"; }
...
private:
    ...
    void updateEngine();
    void generateCCMessages(juce::MidiBuffer& midiMessages);

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(MacroControllerProcessor)
};
